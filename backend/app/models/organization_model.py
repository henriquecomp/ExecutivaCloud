...
class Organization(Base):
    ...
    legalOrganizationId = Column(Integer, ForeignKey("legal_organizations.id"), nullable=False)
    ...
    # Relacionamentos
    legal_organization = relationship("LegalOrganization", back_populates="organizations")
